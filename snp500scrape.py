...
def obtain_parse_wiki_snp500():
    """Download and parse the Wikiedia list of S&P500
    constituents using libxml
    
    Returns a list of tuples for to add to MySQL."""

    #Strores the current time, for the created_at record
    now = datetime.datetime.utcnow()

    # Use libxml to download the list of S&P500
    # companies and obtain the symbol table
    page = lxml.html.parse(
